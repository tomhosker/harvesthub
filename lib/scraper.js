...
class Scraper
{
  ...
  fetchBoxEyeRigLog(req, res)
  {
    ...
    client.query(queryString, [code], (err, result) => {
      ...
      properties = { title: title,  data: data, note: note,
        formAction: "/boxeyecomponents/append2/boxeyerig/"+code };
  ...
  fetchArduinoReaderLog(req, res)
  {
    ...
    client.query(queryString, [code], (err, result) => {
      ...
      that.finaliser.protoRender(req, res, "logtable",
        { title: title,  data: data, note: note,
          formAction: "/boxeyecomponents/append2/arduinoreader/"+code });
    });
  }
  ...
  fetchAntennaLog(req, res)
  {
    ...
    client.query(queryString, [code], (err, result) => {
      ...
      that.finaliser.protoRender(req, res, "logtable",
        { title: title,  data: data, note: note,
          formAction: "/boxeyecomponents/append2/antenna/"+code });
    });
  }
